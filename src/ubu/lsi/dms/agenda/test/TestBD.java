...
public class TestBD {
	...
	public void test2Contactos() {
		try {
			...
			Contacto contacto = new Contacto(102, "pepe", "calabaza", "sr",
					...
					"asdfa", "adsfa", "992341", "123", "1325123", "123123",
					"adsf", "notas", tipoContacto1);
	...
	public void test3Llamadas() {
		try {
			...
			Collection<Llamada> llmadadas2 = fachada
					.consultarLlamadas(contacto);
	...
	public void test4bd() {
		try {
			...
			Collection<Contacto> cc = fachada
					.consultarContactos("Apellidos010");
